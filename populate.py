...
# Criar funcao de carregamento de dados
...
# Criando a conexao
conn = psycopg2.connect(host='localhost', port='5432', database='postgres', user='user', password='admin')

# Chamando a funcao e passando as propriedades
